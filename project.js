...
function renderProducts(arr) {
    ...
    arr.forEach((ele, index) => {
        ...
        // p3.ele.model.style.CSStext="fontSize=25px; fontWeight=700"
        // p3.ele.color.style.CSStext="fontSize=15px; fontWeight=100"
